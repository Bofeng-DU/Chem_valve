"""
"Chemputer_Device_API" -- API only for Chemputer valves
============================================================
.. module:: Chemputer_Device_API
Author: 16.07.2021 BOFENG DU, TUB/BAM
This API is intended for controlling a set of Chemputer valves over a local TCP network.
"""
